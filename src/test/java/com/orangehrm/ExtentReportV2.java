...
public class ExtentReportV2 extends BaseTest {
    WebDriver driver;
    ...
    public void LoginToOrangeHRM() {
        ...
        // ExtentManager.getTest().log(LogStatus.INFO, "Step 01: Enter to Username textbox with value is '" + "hoanglong98" + "'");
        loginPage.enterToUsername("hoanglong98");
        // ExtentManager.getTest().log(LogStatus.INFO, "Step 02: Enter to Password textbox with value is '" + "Long01101998@" + "'");
        loginPage.enterToPassword("Long01101998@");
        //  ExtentManager.getTest().log(LogStatus.INFO, "Step 03: Click to Login button");
        ...
        //  ExtentManager.getTest().log(LogStatus.INFO, "Step 04: Verify Spinner loading is invisible");
    ...
    public void AddNewEmployee() {
        ...
        //  ExtentManager.getTest().log(LogStatus.INFO, "Step 01: Open PIM page");
        homePage.openPageByPageName("PIM");
        //    ExtentManager.getTest().log(LogStatus.INFO, "Step 02: Verify Spinner loading is invisible");
        verifyTrue(homePage.isSpinnerLoadingInvisible());
        //  ExtentManager.getTest().log(LogStatus.INFO, "Step 03: Click on Add Employee button");
        pimPage.clickOnAddEmployee();
        //  ExtentManager.getTest().log(LogStatus.INFO, "Step 04: Input to First Name textbox with value is '" + firstName + "'");
        pimPage.getAddEmployeePage().setFirstName(firstName);
        //  ExtentManager.getTest().log(LogStatus.INFO, "Step 05: Input to Last Name textbox with value is '" + lastName + "'");
        pimPage.getAddEmployeePage().setLastName(lastName);
        //  ExtentManager.getTest().log(LogStatus.INFO, "Step 06: Get Employee ID");
        employeeId = pimPage.getAddEmployeePage().getEmployeeId();
        //  ExtentManager.getTest().log(LogStatus.INFO, "Step 06: Click on Save button");
    ...
    public void VerifyNewEmployee() {
        ...
        //  ExtentManager.getTest().log(LogStatus.INFO, "Step 01: Verify new employee information is displayed correctly");
        ...
        //   ExtentManager.getTest().log(LogStatus.INFO, "First Name - Expected: '" + firstName + "' - Actual: '" + actualFirstName + "'");
        Assert.assertEquals(actualFirstName, lastName);
        //   ExtentManager.getTest().log(LogStatus.INFO, "Last Name - Expected: '" + lastName + "' - Actual: '" + actualLastName + "'");
        Assert.assertEquals(actualLastName, firstName);
        //   ExtentManager.getTest().log(LogStatus.INFO, "Employee ID - Expected: '" + employeeId + "' - Actual: '" + actualEmployeeId + "'");
